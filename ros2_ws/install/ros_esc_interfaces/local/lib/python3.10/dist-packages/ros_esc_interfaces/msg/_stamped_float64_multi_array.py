...
class Metaclass_StampedFloat64MultiArray(type):
    """Metaclass of message 'StampedFloat64MultiArray'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__stamped_float64_multi_array
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__stamped_float64_multi_array
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__stamped_float64_multi_array
            cls._TYPE_SUPPORT = module.type_support_msg__msg__stamped_float64_multi_array
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__stamped_float64_multi_array
...
class StampedFloat64MultiArray(metaclass=Metaclass_StampedFloat64MultiArray):
    """Message class 'StampedFloat64MultiArray'."""
