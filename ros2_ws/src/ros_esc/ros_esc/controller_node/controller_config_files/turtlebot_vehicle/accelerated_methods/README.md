# Accelerated Controller Configs

HeavyBall controller configs live directly in this `accelerated_methods/`
folder, matching the existing adaptive/gradient-method layout style.
