...
pause_sim_until_cost_surface_ready:='True' \
...
controller_config_filepath:='~/dsim-lab/ros2_ws/src/ros_esc/ros_esc/controller_node/controller_config_files/turtlebot_vehicle/accelerated_methods/hbesc_controller_full_rotation_voltage.json' \
pde_omega:=5.0 \
pde_cost_history_topic:='/cost_modified' \
convergence_threshold:=0.2 \
convergence_decay_rate:=0.15 \
convergence_min_fill_periods:=2.0 \
gaussian_fill_amplitude:=0.10 \
