...
cost_surface_start_delay_sec:=30.0 \
cost_surface_x_min:=-0.5 \
cost_surface_x_max:=4.5 \
cost_surface_y_min:=-0.75 \
...
controller_config_filepath:='~/dsim-lab/ros2_ws/src/ros_esc/ros_esc/controller_node/controller_config_files/turtlebot_vehicle/gradient_methods/gesc_controller_full_rotation_voltage.json' \
pde_omega:=5.0 \
...
light_1_x:=1.0 \
light_1_y:=0.0 \
light_1_intensity_lumens:=250.0 \
light_2_x:=1.0 \
light_2_y:=1.0 \
light_2_intensity_lumens:=1500.0 \
light_3_x:=3.0 \
light_3_y:=3.0 \
