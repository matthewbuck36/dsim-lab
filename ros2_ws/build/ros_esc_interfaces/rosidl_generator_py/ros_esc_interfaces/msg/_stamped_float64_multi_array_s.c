...
bool ros_esc_interfaces__msg__stamped_float64_multi_array__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros_esc_interfaces.msg._stamped_float64_multi_array.StampedFloat64MultiArray", full_classname_dest, 76) == 0);
  }
  ros_esc_interfaces__msg__StampedFloat64MultiArray * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of StampedFloat64MultiArray */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros_esc_interfaces.msg._stamped_float64_multi_array");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "StampedFloat64MultiArray");
