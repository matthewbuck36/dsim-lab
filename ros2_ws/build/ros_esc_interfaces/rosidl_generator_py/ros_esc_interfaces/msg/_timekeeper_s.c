...
bool ros_esc_interfaces__msg__timekeeper__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros_esc_interfaces.msg._timekeeper.Timekeeper", full_classname_dest, 45) == 0);
  }
  ros_esc_interfaces__msg__Timekeeper * ros_message = _ros_message;
  {  // mode
...
{
  /* NOTE(esteve): Call constructor of Timekeeper */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros_esc_interfaces.msg._timekeeper");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Timekeeper");
