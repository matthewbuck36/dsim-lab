...
bool ros_esc_interfaces__msg__stamped_string__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros_esc_interfaces.msg._stamped_string.StampedString", full_classname_dest, 52) == 0);
  }
  ros_esc_interfaces__msg__StampedString * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of StampedString */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros_esc_interfaces.msg._stamped_string");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "StampedString");
