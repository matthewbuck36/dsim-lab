...
```bash
docs/DSIM_GESC_Gaussian_Codex_Implementation_Package/tools/init_phase_status.sh XX
```
...
```bash
docs/DSIM_GESC_Gaussian_Codex_Implementation_Package/tools/validate_phase_context.sh XX plan
docs/DSIM_GESC_Gaussian_Codex_Implementation_Package/tools/validate_phase_context.sh XX implement
```
...
```bash
docs/DSIM_GESC_Gaussian_Codex_Implementation_Package/tools/make_codex_context_bundle.sh
```
