...
```bash
docs/DSIM_GESC_Gaussian_Codex_Implementation_Package/tools/init_phase_status.sh 07
docs/DSIM_GESC_Gaussian_Codex_Implementation_Package/tools/validate_phase_context.sh 07 implement
```
...
- Record exact evidence continuously and run `checkpoint_phase.sh 07` at material or independently reviewable boundaries.
