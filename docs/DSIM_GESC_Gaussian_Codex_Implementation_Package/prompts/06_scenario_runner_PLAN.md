...
```bash
docs/DSIM_GESC_Gaussian_Codex_Implementation_Package/tools/validate_phase_context.sh 06 plan
```
...
Read:
- `docs/DSIM_GESC_Gaussian_Codex_Implementation_Package/06_TEST_MATRIX_AND_ACCEPTANCE_GATES.md`
- `docs/DSIM_GESC_Gaussian_Codex_Implementation_Package/templates/scenario_example.yaml`
