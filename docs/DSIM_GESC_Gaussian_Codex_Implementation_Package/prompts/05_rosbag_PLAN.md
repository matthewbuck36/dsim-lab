...
```bash
docs/DSIM_GESC_Gaussian_Codex_Implementation_Package/tools/validate_phase_context.sh 05 plan
```
...
- `docs/DSIM_GESC_Gaussian_Codex_Implementation_Package/templates/topic_manifest.yaml`
- `docs/DSIM_GESC_Gaussian_Codex_Implementation_Package/templates/experiment_metadata.yaml`
