...
The baseline scenarios used for this report are archived for provenance:
\begin{verbatim}
~/dsim-lab/writing/heavy_ball_PDE_ESC/archive/scenarios/baseline_tests/
\end{verbatim}

The original scenario-runner script has been retired from the active ROS tree.

After filling in \texttt{baseline\_hb\_run\_manifest.csv}, analyze completed
runs:
\begin{verbatim}
