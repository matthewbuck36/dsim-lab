...
```bash
DSIM_GESC_Gaussian_Codex_Implementation_Package/tools/init_phase_status.sh 03
...
- After each verified milestone, record exact evidence and run `checkpoint_phase.sh 03`.
